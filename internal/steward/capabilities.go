...
func DriverCapabilities() map[string]any {
	return map[string]any{
		...
		"ingress":               []any{map[string]any{"id": "hysteria2", "state": "supported", "version": "2.12.2", "transport": "udp", "address_families": []string{"ipv4", "ipv6"}, "credential_model": "local-canonical-pinned-tls", "reliability": []string{"salamander-obfuscation", "optional-port-hopping"}}},
