...
func Capabilities() []Capability {
	...
	return []Capability{
		...
		capability("migrate-route", "workflow", true, "remote-write", "Overlap-first workflow composed from add/deploy/audit operations; old capacity is not retired automatically.", []ContextField{target("route-id", true), field("replacement_server_id", "server-id", true)}, "create-and-validate-overlap"),
